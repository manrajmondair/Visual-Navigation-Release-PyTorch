...
def test_cost_function(plot=False):
    ...
    pos_nk2 = torch.constant([[[8., 16.], [8., 12.5], [18., 16.5]]], dtype=torch.float32)
    ...
    expected_overall_objective = torch.reduce_mean(expected_objective1 + expected_objective2 + expected_objective3, axis=1)
