...
class GoalDistance(Objective):
    ...
    def __init__(self, params, fmm_map):
        ...
        self.cost_at_margin = self.p.goal_cost*torch.pow(self.p.goal_margin, self.p.power)
    ...
    def evaluate_objective(self, trajectory):
        ...
        return self.p.goal_cost*torch.pow(dist_to_goal_nk, self.p.power)-self.cost_at_margin
