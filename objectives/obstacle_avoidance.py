...
class ObstacleAvoidance(Objective):
    ...
    def evaluate_objective(self, trajectory):
        ...
        infringement_nk = torch.nn.relu(self.p.obstacle_margin1 - dist_to_obstacles_nk)
        return self.p.obstacle_cost*torch.pow(infringement_nk/self.factor, self.p.power)
